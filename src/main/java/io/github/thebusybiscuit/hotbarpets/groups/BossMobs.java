...
public final class BossMobs implements PetGroup {
    ...
    public void load(HotbarPets plugin) {
        ...
        new HotbarPet(plugin.getCategory(), new SlimefunItemStack("HOTBAR_PET_WITHER", PetTexture.WITHER_PET.getHash(), "&8凋零寵物", getName(), "&7喜愛的食物: 靈魂沙", "", "&f免疫凋零"), new ItemStack(Material.SOUL_SAND), new ItemStack[]{

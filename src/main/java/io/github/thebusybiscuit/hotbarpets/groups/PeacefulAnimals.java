...
public final class PeacefulAnimals implements PetGroup {
    ...
    public void load(HotbarPets plugin) {
        // @formatter:off
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_FISH", PetTexture.FISH_PET.getHash(), "&3魚寵物", getName(), "&7喜愛的食物: 種子", "", "&f隨著時間的推移給予你魚..."), new ItemStack(Material.WHEAT_SEEDS), new ItemStack[] {
        ...
        new SquidPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_SQUID", PetTexture.SQUID_PET.getHash(), "&b魷魚寵物", getName(), "&7喜愛的食物: 生鱈魚", "", "&f右鍵點擊: &7給予你水下呼吸"), new ItemStack(Material.COD), new ItemStack[] {
        ...
        new RabbitPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_RABBIT", PetTexture.RABBIT_PET.getHash(), "&e兔兔寵物", getName(), "&7喜愛的食物: 胡蘿蔔", "", "&f右鍵點擊: &7給予你30秒幸運"), new ItemStack(Material.CARROT), new ItemStack[] {
        ...
        new DolphinPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_DOLPHIN", PetTexture.DOLPHIN_PET.getHash(), "&b海豚寵物", getName(), "&7喜愛的食物: 墨囊", "", "&f右鍵點擊: &7海豚悠游"), new ItemStack(Material.INK_SAC), new ItemStack[] {
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_PANDA", PetTexture.PANDA_PET.getHash(), "&8熊貓&f寵物", getName(),"&7喜愛的食物: 竹子", "", "&f這隻可愛的困困熊貓保護你免受於失眠困擾", "&f夜魅將不在晚上追你"), new ItemStack(Material.BAMBOO), new ItemStack[] {

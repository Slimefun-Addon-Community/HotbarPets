...
public final class UtilityPets implements PetGroup {
    ...
    public void load(HotbarPets plugin) {
        // @formatter:off
        new BedPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_BED", Material.RED_BED, "&f床寵物", getName(), "&7喜愛的食物: 羊毛", "", "&f右鍵點擊: &7開啟"), new ItemStack(Material.WHITE_WOOL), new ItemStack[] {
        ...
        new EnderChestPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_ENDER_CHEST", PetTexture.ENDER_CHEST_PET.getHash(), "&5終界箱寵物", getName(), "&7喜愛的食物: 終界珍珠", "", "&f右鍵點擊: &7開啟"), new ItemStack(Material.ENDER_PEARL), new ItemStack[] {
        ...
        new WorkbenchPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_WORKBENCH", PetTexture.WORKBENCH_PET.getHash(), "&6工作臺寵物", getName(), "&7喜愛的食物: 木材", "", "&f右鍵點擊: &7開啟"), new ItemStack(Material.OAK_PLANKS), new ItemStack[] {

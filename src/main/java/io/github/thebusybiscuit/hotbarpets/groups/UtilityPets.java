...
public final class UtilityPets implements PetGroup {
	...
	public void load(HotbarPets plugin) {
		new BedPet(plugin.getCategory(), new SlimefunItemStack("HOTBAR_PET_BED", Material.RED_BED, "&rBed Pet", getName(), "&7Favourite Food: Wool", "", "&rRight-Click: &7Sleep"), new ItemStack(Material.WHITE_WOOL), new ItemStack[]{

...
public final class PassiveMobs implements PetGroup {
    ...
    public void load(HotbarPets plugin) {
        // @formatter:off
        new IronGolemPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_IRON_GOLEM", PetTexture.IRON_GOLEM_PET.getHash(), "&7鐵巨人寵物", getName(), "&7喜愛的食物: 鐵錠", "", "&f右鍵點擊: &7給予你抗性"), new ItemStack(Material.IRON_INGOT), new ItemStack[]{
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_SLIME", PetTexture.SLIME_PET.getHash(), "&a史萊姆寵物", getName(), "&7喜愛的食物: 螢光粉", "", "&f免疫摔落傷害"), new ItemStack(Material.GLOWSTONE_DUST), new ItemStack[]{

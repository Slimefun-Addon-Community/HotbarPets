...
public final class HostileMobs implements PetGroup {
    ...
    public void load(HotbarPets plugin) {
        // @formatter:off
        new SpiderPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_SPIDER", PetTexture.SPIDER_PET.getHash(), "&8蜘蛛寵物", getName(), "&7喜愛的食物: 腐肉", "", "&f右鍵點擊: &7給予你跳躍提升"), new ItemStack(Material.ROTTEN_FLESH), new ItemStack[]{
        ...
        new GhastPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_GHAST", PetTexture.GHAST_PET.getHash(), "&f地域幽靈寵物", getName(), "&7喜愛的食物: 火焰彈", "", "&f右鍵點擊: &7發射火焰彈"), new ItemStack(Material.FIRE_CHARGE), new ItemStack[]{
        ...
        new PhantomPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_PHANTOM", PetTexture.PHANTOM_PET.getHash(), "&7夜魅寵物", getName(), "&7喜愛的食物: 甜菜根", "", "&f右鍵點擊: &7給予你緩降"), new ItemStack(Material.BEETROOT), new ItemStack[]{
        ...
        new EndermanPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_ENDER_MAN", PetTexture.ENDERMAN_PET.getHash(), "&8安德寵物", getName(), "&7喜愛的食物: 終界石", "", "&f右鍵點擊: &7發射終界珍珠"), new ItemStack(Material.END_STONE), new ItemStack[]{
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_MAGMA_CUBE", PetTexture.MAGMA_CUBE_PET.getHash(), "&4熔岩史萊姆寵物", getName(), "&7喜愛的食物: 地獄石英", "", "&f免疫岩漿", "&f會餓"), new ItemStack(Material.QUARTZ), new ItemStack[]{
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_BLAZE", PetTexture.BLAZE_PET.getHash(), "&6烈焰使者寵物", getName(), "&7喜愛的食物: 地獄石英", "", "&f免疫火"), new ItemStack(Material.QUARTZ), new ItemStack[]{
        ...
        new HotbarPet(plugin.getItemGroup(), new SlimefunItemStack("HOTBAR_PET_ZOMBIE", Material.ZOMBIE_HEAD, "&2殭屍寵物", getName(), "", "&f讓你吃腐肉", "&f沒有飢餓"), new ItemStack(Material.ROTTEN_FLESH), new ItemStack[] {

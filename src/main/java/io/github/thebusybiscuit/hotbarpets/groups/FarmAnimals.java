...
public final class FarmAnimals implements PetGroup {
    ...
    public void load(HotbarPets plugin) {
        ...
        new HotbarPet(plugin.getCategory(), new SlimefunItemStack("HOTBAR_PET_PIG", PetTexture.PIG_PET.getHash(), "&d豬寵物", getName(), "&7喜愛的食物: 胡蘿蔔", "", "&f進食時增加飽食度", "&f允許你食用有毒的食物"), new ItemStack(Material.CARROT), new ItemStack[] {
        ...
        new HotbarPet(plugin.getCategory(), new SlimefunItemStack("HOTBAR_PET_CHICKEN", PetTexture.CHICKEN_PET.getHash(), "&f雞寵物", getName(), "&7喜愛的食物: 種子", "", "&f隨著時間的推移而生蛋..."), new ItemStack(Material.WHEAT_SEEDS), new ItemStack[] {
        ...
        new HotbarPet(plugin.getCategory(), new SlimefunItemStack("HOTBAR_PET_MOOSHROOM", PetTexture.MOOSHROOM_PET.getHash(), "&d蘑菇牛寵物", getName(), "&7喜愛的食物: 紅蘑菇", "", "&f一段時間內給予你蘑菇方塊..."), new ItemStack(Material.RED_MUSHROOM), new ItemStack[] {
        ...
        new HotbarPet(plugin.getCategory(), new SlimefunItemStack("HOTBAR_PET_GOLDEN_COW", PetTexture.GOLDEN_COW_PET.getHash(), "&6黃金牛寵物", getName(), "&7喜愛的食物: 金胡蘿蔔", "", "&f隨著時間的推移給予你金錠...", "&f(這意味著你有1個金粒的淨收益)"), new ItemStack(Material.GOLDEN_CARROT), new ItemStack[] {
